...
class SwitchUser extends Component {
  ...
  keyPress = key => {
    ...
    let newOption;
    if (
      (key === "right" && optionSelected === "0") ||
      (key === "up" &&
        (optionSelected === "1" || optionSelected === "mainmenu")) ||
      (key === "left" && optionSelected === "2")
    ) {
      newOption = "1";
    } else if (
      (key === "left" && (optionSelected === "0" || optionSelected === "1")) ||
      (key === "up" && optionSelected === "0")
    ) {
      newOption = "0";
    } else if (
      (key === "right" && (optionSelected === "1" || optionSelected === "2")) ||
      (key === "up" && optionSelected === "2")
    ) {
      newOption = "2";
    } else if (
      (key === "down" &&
        (optionSelected === "0" ||
          optionSelected === "1" ||
          optionSelected === "2")) ||
      ((key === "left" || key === "right") && optionSelected === "mainmenu") ||
      (key === "up" && optionSelected === "deleteuser")
    ) {
      newOption = "mainmenu";
    } else if (
      ((key === "down" || key === "left" || key === "right") &&
        optionSelected === "deleteuser") ||
      (key === "down" && optionSelected === "mainmenu")
    ) {
  ...
  render() {
    ...
    return (
      <div
        className={
          "SwitchUser " +
          (theme === "forest" ? "SwitchUser__forest" : "") +
          (theme === "ocean" ? "SwitchUser__ocean" : "") +
          (theme === "mountains" ? "SwitchUser__mountains" : "")
        }
      >
        ...
        <div className="SwitchUser__container">
          ...
          <div className="SwitchUser__main">
            ...
            <div className="SwitchUser__main--subtext">
              logged in as{" "}
              <span className="SwitchUser__main--name">{activeUser.name}</span>
            </div>
            ...
            <Link
              ...
              className={
                this.state.optionSelected === "mainmenu"
                  ? "SwitchUser__link SwitchUser__mainmenu"
                  : "SwitchUser__link"
              }
            >
              Main Menu
            ...
            <div
              ...
              className={
                this.state.optionSelected === "deleteuser"
                  ? "SwitchUser__link SwitchUser__deleteuser"
                  : "SwitchUser__link"
              }
            >
              Delete User
